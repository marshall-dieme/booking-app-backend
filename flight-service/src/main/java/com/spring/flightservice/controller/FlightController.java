...
public class FlightController {
    ...
    public List<Flight> getFlights(
        ...
        // try to retrieve 20 flights from the database with pagination and return them
        // as a list
    ...
    // create a new flight
    @PostMapping
    public Flight createFlight(@RequestBody @Validated Flight flight) {
    ...
    // update a flight
    @PutMapping
    public Flight updateFlight(@Validated @RequestBody Flight flight) {
